            ...
            <div className="areas-page-container">
                ...
                <div className="main-content">
                    <div className="content-left">
                        <div className="block">
                            <div className="big-title">Damac Lagoons</div>
                            <div className="description">
                                <div className="text">Damac Lagoons is a waterfront residential community situated in Dubai’s International Media Production Zone (IMPZ). It is a part of the larger Dubailand project and is developed by Damac Properties.</div>
                                <div className="text">The community features a range of residential properties, including apartments, townhouses, and villas, that offer a luxurious and comfortable living experience.</div>
                                <div
                                    className="image"
                        ...
                        <div className="block">
                            ...
                            <div className="description">
                                <div className="text">Damac Lagoons offers a range of amenities and facilities to its residents, including supermarkets, retail outlets, restaurants, and cafes. The community also features several parks and green spaces, as well as sports facilities and playgrounds for children.</div>
                                <div className="text">There are several schools in and around Damac Lagoons, including Gems Metropole School and Jebel Ali School. These schools offer high-quality education to students of all ages, from pre-school to secondary school.</div>
                                <div className="text">The healthcare needs of residents in Damac Lagoons are catered to by several hospitals and clinics in the surrounding areas, including the Mediclinic Parkview Hospital and Aster Clinic in Arabian Ranches.</div>
                                <div className="text">Damac Lagoons is located in close proximity to some of the most stunning beaches in Dubai. The community is situated a few minutes’ drive away from the beaches of Jumeirah and Dubai Marina. These beaches are known for their pristine waters and beautiful scenery.</div>
                ...
                <div className="lower-container">
                    <div className="block">
                        ...
                        <div className="description">
                            <div className="text">Damac Lagoons is situated close to a range of leisure activities and notable landmarks. For those who enjoy the outdoors, there are several parks, cycling tracks, and walking trails in the vicinity of the community. The Dubai Miracle Garden, one of the world’s largest flower gardens, is also located nearby, providing visitors with a colorful and picturesque setting to explore.</div>
                            <div className="text">The Dubai Autodrome, a world-class race track, is located a few minutes’ drive from the community, providing motorsports enthusiasts with an exciting destination to visit. Another notable landmark near Damac Lagoons is the Dubai Fountain, a spectacular water and light show located in the heart of Downtown Dubai.</div>
                            <div className="text">Additionally, there are several golf courses located near the community, including the Trump International Golf Club and the Emirates Golf Club, providing golfers with world-class facilities to enjoy.</div>
                        </div>
                    </div>
                    ...
                    <div className="block">
                        ...
                        <div className="description">
                            <div className="text">Damac Lagoons is located in the heart of Dubai and is surrounded by several other popular communities. These include Jumeirah Village Circle, Jumeirah Village Triangle, and Dubai Sports City. The area is also in close proximity to the bustling Dubai Marina, which is home to numerous restaurants, shops, and entertainment options.</div>
                            <div className="text">The transportation options in and around the area are excellent, with easy access to major highways and public transportation. There are several bus and metro stations located nearby, providing easy access to other areas of Dubai.</div>
                            <div className="text">Damac Lagoons is located in close proximity to some of the most stunning beaches in Dubai. The community is situated a few minutes’ drive away from the beaches of Jumeirah and Dubai Marina. These beaches are known for their pristine waters and beautiful scenery.</div>
                        </div>
                    </div>
