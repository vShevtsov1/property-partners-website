...
const Home = () => {
    ...
    const dummyArray = Array.from({ length: visibleMembers }, (_, index) => index);
    ...
    return (<div className={"home-page"}>
        ...
        <div className="collections">
            <div className="tittle">
                ...
                <div>We prepared special offers for different types of requests. From budget apartments to luxurious
                    villas
                    Choose the best option for you, and our expert will reach you out in 5 minutes
                </div>
            </div>
            <div className="content">
                    ...
                    <div className={`type ${activeKind === 0 ? 'active' : ''}`} >
                        <div className="visible-element" onClick={() => handleTypeClick(0)}>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <path d="M12 13.1722L16.95 8.22217L18.364 9.63617L12 16.0002L5.63599 9.63617L7.04999 8.22217L12 13.1722Z" fill="#191C38"/>
                            </svg>
                        </div>
                        <div className="hiden-text">Our partners are Dubai's largest real estate developers, which will allow you to get insider information on new projects.</div>
                    </div>
        ...
        <div className="contact-form">
            ...
            <div className="contact-form-form">
                <div className="tittle">
                    <div>Would you like to the first to know about the launches of sales of promising projects in Dubai?</div>
                    <div>Text your phone number, and our real estate expert real estate expert will contact you within 5 minutes.</div>
                </div>
                <div className="form">
                    ...
                    <div className="form-text">By clicking on the button you agree to the terms and conditions of data processing data processing and privacy policy</div>
                </div>
            </div>
        </div>
        <Footer/>
