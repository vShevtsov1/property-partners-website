...
const PDFmodal = ({closeModal,showModal}) => {
            ...
            <div className="modal-form">
                ...
                <div className="form">
                    ...
                    <div className="form-form">
                        ...
                        <a href="https://drive.google.com/file/d/1yTp_KSKgA768y1bEB_Z4RmKVrTRL8Hie/view?usp=share_link" download><div className="form-button">
                            Get offers in PDF
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
